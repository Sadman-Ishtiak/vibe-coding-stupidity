                ...
                <div className="me-lg-0">
                  <div className="job-list-header">
                    <div className="d-flex justify-content-start mb-2">
                      <div className="btn-group" role="group" aria-label="Job view">
                        <Link to="/job-list" className="btn btn-outline-primary btn-sm" aria-label="Job list view">
                          <i className="mdi mdi-format-list-bulleted"></i>
                        </Link>
                        <Link to="/job-grid" className="btn btn-primary btn-sm" aria-label="Job grid view">
                  ...
                  <div className="row">
                    {loading ? (
                      ...
                      jobs.map((job) => <JobGridCard key={job._id || job.id} job={job} onApply={setSelectedJobId} />)
                    )}
                  </div>
