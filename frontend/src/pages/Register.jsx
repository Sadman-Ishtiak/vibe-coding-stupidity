...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Backend returns validation errors in err.response.data.error usually
      const msg = err?.response?.data?.error || err?.response?.data?.message || 'Unable to create account. Please try again.';
      setError(msg);
    } finally {
      setLoading(false);
    }
