...
<!-- START SHAPE -->
                    ...
                    <section class="section">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <h5 class="mb-4">Use for InternNova</h5>
                                    <ul class="about-list list-unstyled text-muted mb-4 pb-2">
                                        <li>
                                             At InternNova, accessible at Website.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by InternNova and how we use
                                            If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us through email at <b class="text-danger">InternNovatechnologypvt.ltd.com</b>
                                        </li>
                                        <li>
                                    ...
                                    <div class="text-end">
                                        <a href="javascript:void(0)" class="btn btn-primary"><i class="uil uil-print"></i> Print</a>
                                    </div>
...
export default function PrivacyPolicy() {
    return <StaticMarkupPage slug="privacy-policy" />
}
