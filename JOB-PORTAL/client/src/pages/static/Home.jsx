                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-7">
                                    <div class="mb-4 pb-3 me-lg-5">
                                        ...
                                        <h1 class="display-5 fw-semibold mb-3">Find your dream jobs with <span class="text-primary fw-bold">InternNova</span></h1>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-2 mb-md-0">
                                                                <h5 class="fs-18 mb-1"><a href="job-details.html" class="text-dark">Digital Marketing
                                                                        Manager</a></h5>
                                                                <p class="text-muted fs-14 mb-0">InternNova Technology Pvt.Ltd</p>
                                                            </div>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-md-3">
...
`
    ...
    return <StaticMarkupPage slug="index" />
    }
