                            ...
                            <div class="row align-items-center mt-5">
                                <div class="col-lg-6">
                                    <div class="section-title mt-4 mt-lg-0">
                                        ...
                                        <p class="text-muted">Start working with InternNova that can provide everything you need to generate
                                ...
                                <div class="col-lg-5 ms-auto order-first order-lg-last">
                                    ...
                                    <div class="mt-4 pt-3">
                                        ...
                                        <div class="d-flex text-muted align-items-center mt-2">
                                            ...
                                            <div class="flex-grow-1 ms-2">
                                                <p class="mb-0">contactus@InternNova.com</p>
                                            </div>
                                        </div>
                                        <div class="d-flex text-muted align-items-center mt-2">
                                            <div class="flex-shrink-0 fs-22 text-primary">
...
`
    ...
    return <StaticMarkupPage slug="contact" />
    }
